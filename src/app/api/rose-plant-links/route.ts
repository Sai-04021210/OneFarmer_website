...
const storageDir = path.join(process.cwd(), 'public/uploads/rose-plant-links');
...
const loadMetadata = async (): Promise<LinkMetadata[]> => {
  try {
    ...
    console.error('Failed to load rose plant link metadata:', error);
  }
  return [];
};
...
const saveMetadata = async (metadata: LinkMetadata[]): Promise<void> => {
  try {
    ...
    console.error('Failed to save rose plant link metadata:', error);
  }
};
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Use ROSE_PLANT as stemId for rose plant link uploads
    ...
    console.error('Rose plant link creation error:', error);
    return NextResponse.json(
...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('Rose plant link fetch error:', error);
    return NextResponse.json(
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    console.error('Rose plant link delete error:', error);
    return NextResponse.json(
